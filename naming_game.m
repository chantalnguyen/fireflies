function naming_game(w1,a1,num_species,num_flies,mutate_prob,max_iter,seq_length)
...
sequence_matrix = ones(num_flies,seq_length,num_species);
scores = cell(num_flies*num_species,1);

sequences = zeros(num_species,seq_length,max_iter);
...
for t = 1:max_iter
    ...
    if t == 1
        for i = 1:num_species
            for j = 1:num_flies
                ...
                fitness_orig(j,t,i) = (a1/(w1+a1))*score + fitness;
            end
        end
    end
    ...
    for species = 1:num_species
        ...
        sequence_matrix(:,:,species) = repmat(sequence_matrix(ind(1),:,species),num_flies,1);
